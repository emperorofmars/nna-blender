...
_nna_name = "vrc.contact_sender"


def display_vrc_contact_sender_component(target_id: str, layout: bpy.types.UILayout, json_component: dict, component_index: int):
...
nna_types = {
	_nna_name: {
		NNAFunctionType.JsonDisplay: display_vrc_contact_sender_component,
	},
}
